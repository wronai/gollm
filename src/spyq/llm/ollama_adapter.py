# src/spyq/llm/ollama_adapter.py
import asyncio
import json
import aiohttp
...
class OllamaAdapter:
    ...
    async def generate_code(self, prompt: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        # Przygotuj prompt z kontekstem SPYQ
    ...
    def _format_prompt_for_ollama(self, user_prompt: str, context: Dict[str, Any]) -> str:
        """Formatuje prompt dla Ollama z kontekstem SPYQ"""
...
class OllamaLLMProvider:
    """Provider LLM dla Ollama - kompatybilny z interfejsem SPYQ"""
    ...
    async def generate_response(self, prompt: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
        """Generuje odpowiedź kompatybilną z interfejsem SPYQ LLM"""
        
        async with self.adapter as adapter:
            result = await adapter.generate_code(prompt, context)
            
            # Konwertuj do formatu oczekiwanego przez SPYQ
            return {
