...
# src/spyq/project_management/changelog_manager.py
import re
...
"""
    ...
    def _format_changelog_entry(self, entry: Dict[str, Any]) -> str:
        ...
        metadata = entry.get('spyq_metadata', {})
        
        # Podstawowy wpis
        formatted = f"- **[SPYQ]** {description}"
    ...
    def get_recent_changes_count(self, days: int = 7) -> int:
        ...
        try:
            ...
            # Proste liczenie wpisów SPYQ z ostatnich dni
            spyq_entries = re.findall(r'- \*\*\[SPYQ\]\*\*', content)
            return len(spyq_entries)
        except:
            return 0
