# src/spyq/ide/vscode_extension.py
import json
import os
...
class VSCodeExtension:
    ...
    def _create_settings(self):
        ...
        settings = {
            ...
            "spyq.enabled": True,
            "spyq.validateOnSave": True,
            "spyq.validateOnType": True,
            "spyq.blockSaveOnViolations": True,
            "spyq.autoFixOnSave": True,
            "spyq.showQualityScore": True,
            "spyq.llmIntegration": True
        }
    ...
    def _create_tasks(self):
        ...
        tasks = {
            ...
            "tasks": [
                ...
                {
                    "label": "SPYQ: Next Task",
                    "type": "shell",
                    "command": "${workspaceFolder}/venv/bin/python",
                    "args": ["-m", "spyq", "next-task"],
                    "group": "build"
                },
                {
                    "label": "SPYQ: Generate Code",
                    "type": "shell",
                    "command": "${workspaceFolder}/venv/bin/python",
                    "args": ["-m", "spyq", "generate", "${input:promptText}"],
                    "group": "build"
                }
            ],
            "inputs": [
