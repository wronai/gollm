...
class SpyqLanguageServer:
    """Language Server Protocol implementation for SPYQ"""
    
    def __init__(self, spyq_core):
    ...
    async def _validate_document(self, uri: str, text: str):
        ...
        try:
            ...
            # Waliduj z SPYQ
            result = self.spyq_core.validate_file(temp_file)
    ...
    def _get_severity(self, severity: str) -> int:
        """Konwertuje severity SPYQ na LSP"""
        severity_map = {
            "error": 1,
            "warning": 2,
            "info": 3,
