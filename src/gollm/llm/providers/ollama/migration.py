...
def apply_migration():
    ...
    try:
        ...
        if os.path.exists(adapter_path):
            ...
            logger.info(f"Removed {adapter_path} (replaced by http/adapter.py and grpc/adapter.py)")
...
def is_migration_needed() -> bool:
    ...
    return (os.path.exists(http_dir) and 
            os.path.exists(grpc_dir) and 
            os.path.exists(adapter_path))
