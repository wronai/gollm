...
class LLMProviderManager:
    ...
    def _initialize_providers(self):
        ...
        for provider_name, provider_config in providers_config.items():
            ...
            try:
                ...
                module = __import__(module_name, fromnames=[f"{provider_name.capitalize()}LLMProvider"])
                provider_class = getattr(module, f"{provider_name.capitalize()}LLMProvider")
    ...
    async def get_response(self, prompt: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
        """
